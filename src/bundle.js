...
},{"cm6-theme-material-dark":7}],2:[function(require,module,exports){
'use strict';
...
},{"@codemirror/state":3,"@codemirror/view":4,"@lezer/common":5,"@lezer/highlight":6,"style-mod":8}],3:[function(require,module,exports){
'use strict';
...
},{"@codemirror/state":3,"style-mod":8,"w3c-keyname":9}],5:[function(require,module,exports){
'use strict';
...
},{"@lezer/common":5}],7:[function(require,module,exports){
'use strict';
...
const invalid = base_red, darkBackground = '#202325', highlightBackground = '#545b61', background = base00, tooltipBackground = base01, selection = base01, cursor = base04;
/**
...
const materialDarkHighlightStyle = language.HighlightStyle.define([
    { tag: highlight.tags.keyword, color: base_purple },
    {
        tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName],
        color: base_cyan
    },
    { tag: [highlight.tags.propertyName], color: base_yellow },
    { tag: [highlight.tags.variableName], color: base05 },
    { tag: [highlight.tags.function(highlight.tags.variableName)], color: base_cyan },
    { tag: [highlight.tags.labelName], color: base_purple },
    {
        tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)],
        color: base_yellow
    },
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base_pink },
    { tag: [highlight.tags.brace], color: base_purple },
    {
    ...
    { tag: [highlight.tags.string], color: base_lightgreen },
    {
        tag: highlight.tags.link,
        color: base_cyan,
        textDecoration: 'underline',
    ...
    { tag: highlight.tags.strong, fontWeight: 'bold', color: base_red },
    { tag: highlight.tags.emphasis, fontStyle: 'italic', color: base_lightgreen },
    { tag: highlight.tags.strikethrough, textDecoration: 'line-through' },
    { tag: highlight.tags.heading, fontWeight: 'bold', color: base_yellow },
    { tag: highlight.tags.heading1, fontWeight: 'bold', color: base_yellow },
    {
    ...
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base_cyan },
    {
...
},{"@codemirror/language":2,"@codemirror/view":4,"@lezer/highlight":6}],8:[function(require,module,exports){
var C = "\u037c"
